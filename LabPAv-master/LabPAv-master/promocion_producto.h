...
class PROMOCION;
class PRODUCTO; //Solucion para la referencia circular (es algo que si o si pasaria en tipos asociativos como este que apunta a ambas clases que lo "generan").
