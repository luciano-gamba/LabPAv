...
${OBJECTDIR}/_ext/a0b48249/Integer.o: ../../Escritorio/ICollection/Integer.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a0b48249/Integer.o ../../Escritorio/ICollection/Integer.cpp

${OBJECTDIR}/_ext/a0b48249/String.o: ../../Escritorio/ICollection/String.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/a0b48249
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/a0b48249/String.o ../../Escritorio/ICollection/String.cpp

${OBJECTDIR}/_ext/977bdecf/List.o: ../../Escritorio/ICollection/collections/List.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/977bdecf
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/977bdecf/List.o ../../Escritorio/ICollection/collections/List.cpp

${OBJECTDIR}/_ext/977bdecf/ListIterator.o: ../../Escritorio/ICollection/collections/ListIterator.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/977bdecf
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/977bdecf/ListIterator.o ../../Escritorio/ICollection/collections/ListIterator.cpp

${OBJECTDIR}/_ext/977bdecf/ListNode.o: ../../Escritorio/ICollection/collections/ListNode.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/977bdecf
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/977bdecf/ListNode.o ../../Escritorio/ICollection/collections/ListNode.cpp

${OBJECTDIR}/_ext/977bdecf/OrderedDictionary.o: ../../Escritorio/ICollection/collections/OrderedDictionary.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/977bdecf
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/977bdecf/OrderedDictionary.o ../../Escritorio/ICollection/collections/OrderedDictionary.cpp

${OBJECTDIR}/_ext/977bdecf/OrderedDictionaryEntry.o: ../../Escritorio/ICollection/collections/OrderedDictionaryEntry.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/977bdecf
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/977bdecf/OrderedDictionaryEntry.o ../../Escritorio/ICollection/collections/OrderedDictionaryEntry.cpp

${OBJECTDIR}/_ext/52371e0/ICollectible.o: ../../Escritorio/ICollection/interfaces/ICollectible.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52371e0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52371e0/ICollectible.o ../../Escritorio/ICollection/interfaces/ICollectible.cpp

${OBJECTDIR}/_ext/52371e0/ICollection.o: ../../Escritorio/ICollection/interfaces/ICollection.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52371e0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52371e0/ICollection.o ../../Escritorio/ICollection/interfaces/ICollection.cpp

${OBJECTDIR}/_ext/52371e0/IDictionary.o: ../../Escritorio/ICollection/interfaces/IDictionary.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52371e0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52371e0/IDictionary.o ../../Escritorio/ICollection/interfaces/IDictionary.cpp

${OBJECTDIR}/_ext/52371e0/IIterator.o: ../../Escritorio/ICollection/interfaces/IIterator.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52371e0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52371e0/IIterator.o ../../Escritorio/ICollection/interfaces/IIterator.cpp

${OBJECTDIR}/_ext/52371e0/IKey.o: ../../Escritorio/ICollection/interfaces/IKey.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52371e0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52371e0/IKey.o ../../Escritorio/ICollection/interfaces/IKey.cpp

${OBJECTDIR}/_ext/52371e0/OrderedKey.o: ../../Escritorio/ICollection/interfaces/OrderedKey.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52371e0
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52371e0/OrderedKey.o ../../Escritorio/ICollection/interfaces/OrderedKey.cpp
